...
const TURTLE_PORTRAIT = "/character/npc/turtle.png";
...
export const NPCS: Record<NpcId, NpcConfig> = {
  turtle_guide: {
    ...
    introLines: [
      ...
      { side: "left", name: "Bạn", portraitSrc: "/character/player/dog.png", text: "Khoan đã... vậy tui đang ở đâu? tui là ai? Sao ông là con rùa?" },
