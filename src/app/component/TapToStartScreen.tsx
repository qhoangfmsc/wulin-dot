    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center gap-7">
        <div className="text-center">
          <h1 className="font-title mt-2 text-7xl font-bold drop-shadow-lg sm:text-6xl">Wulin Animal</h1>
        </div>
        <p className="font-title animate-pulse text-xl uppercase tracking-[0.3em] text-zinc-300 drop-shadow">
          Tap to Start
        </p>
      </div>
    </button>
